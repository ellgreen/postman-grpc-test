...
const (
	...
	TestService_SayGoodbye_FullMethodName = "/test.TestService/SayGoodbye"
)
...
func (c *testServiceClient) SayGoodbye(ctx context.Context, in *SayGoodbyeRequest, opts ...grpc.CallOption) (*SayGoodbyeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SayGoodbyeResponse)
	err := c.cc.Invoke(ctx, TestService_SayGoodbye_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTestServiceServer) SayGoodbye(context.Context, *SayGoodbyeRequest) (*SayGoodbyeResponse, error) {
...
func _TestService_SayGoodbye_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServiceServer).SayGoodbye(ctx, req.(*SayGoodbyeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
